...
cmd = "~/ADC/scientific_analysis/bin/AG_srcloc " + exp.to_s + " " + cts.to_s + " " + gas.to_s + " ~/ADC/scientific_analysis/data/" + sarmatrix.to_s + " ~/ADC/scientific_analysis/data/" + edpmatrix.to_s + " ~/ADC/scientific_analysis/data/" + psdmatrix.to_s + " " + spectralindex.to_s + " " + emin.to_s + " " + emax.to_s + " " + l.to_s + " " + b.to_s + " " + outfile.to_s  + " " + gascoeff.to_s + " " + iso.to_s + " " + ranal.to_s;
puts cmd
system(cmd)